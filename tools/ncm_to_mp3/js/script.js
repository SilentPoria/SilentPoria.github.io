...
function createListItem(res) {
	...
	td4.insertAdjacentHTML('beforeend', '<button onclick="downloadlink(' +
		"'" +  randID+1 + "'" +
		')" type="button" class="btn success"><span>下载</span></button>');
	td5.insertAdjacentHTML('beforeend', '<button onclick="removeElementByID(' +
	"'" +  randID + "'" +
	')" type="button" class="btn btn-warning delete"><span>删除</span></button>');
