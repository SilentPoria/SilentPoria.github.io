...
(function() {
 ...
 loadPackage({
  "files": [ {
   "filename": "/pikafish.nnue",
   "start": 0,
   "end": 3136990
  } ],
  "remote_package_size": 3136990
 });
})();
...
var PThread = {
 ...
 initMainThread: function() {
  var pthreadPoolSize = 1 + navigator.hardwareConcurrency;
...
function ___syscall_openat(dirfd, path, flags, varargs) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(8, 1, dirfd, path, flags, varargs);
 SYSCALLS.varargs = varargs;
 try {
...
function _tzset_impl(timezone, daylight, tzname) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, timezone, daylight, tzname);
...
var proxiedFunctionTable = [ null, _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_ioctl, ___syscall_openat, _tzset_impl, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var __emscripten_proxy_main = Module["__emscripten_proxy_main"] = function() {
 return (__emscripten_proxy_main = Module["__emscripten_proxy_main"] = Module["asm"]["_emscripten_proxy_main"]).apply(null, arguments);
};
